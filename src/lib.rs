...
pub use template::{
    ...
    COLLECTION_ID_DOMAIN, COLLECTION_METADATA_FORMAT_V1, COLLECTION_METADATA_RECORD_ID,
    COLLECTION_TEMPLATE_FORMAT_V1, COLLECTION_TYPE_APP_BASE, COLLECTION_TYPE_INTERNAL_BASE,
    COLLECTION_TYPE_PROTOCOL_BASE, COLLECTION_TYPE_UNSET,
};
